                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mt-2">
                                ...
                                <p class="card-text">{{ $data->from }}</p>
                            </div>
                            <div class="mt-2">
                                <h5 class="mb-75">Nomor Surat</h5>
                                <p class="card-text">{{ $data->letter_number }}</p>
                            </div>
                            <div class="mt-2">
                                <h5 class="mb-75">Tanggal Surat</h5>
                                <p class="card-text">{{ $data->letter_date }}</p>
                            </div>
                            <div class="mt-2">
...
@section('script')
    ...
    <script src="{{ asset('assets/js/scripts/tables/headmaster/table-headmaster-incoming-datatables.js') }}"></script>
@endsection
