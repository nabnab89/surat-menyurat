...
<body>
    ...
    <div class="container">
        ...
        <table style="border: solid; width: max-content; padding: 10px; margin-top: -2.4px">
            <tbody>
                <tr>
                    ...
                    <td style="width: 8cm"><br>{{ $incoming->number }}</td>
        ...
        <table style="border: solid; width: max-content; padding: 10px; margin-top: -2.4px">
            <tbody>
                <tr>
                    <td style="height: 3cm; width: 3cm; border-right: solid">Instruksi</td>
                    <td style="height: 3cm; width: 3cm; padding-left: 10px">Diteruskan</td>
                </tr>
            </tbody>
        </table>
        <table style="border: solid; width: max-content; padding: 10px; margin-top: -2.4px">
